...
public class patient_dashboard extends JFrame implements dashboard_factory {
	JPanel panel;
	JPanel button_panel;
	JFrame frame;
	...
	//Constructor
	public patient_dashboard(String userName) {
				...
				for (String key: patientList.getPatientList().keySet()) {
					...
					button.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent ae) {
							...
							String tbc = key;
							cholestrolModel model = new cholestrolModel(tbc);
							patient_chartPanel chart;
							try {
								chart = new patient_chartPanel(model, tbc);
